...
class Booking(models.Model):
    ...
    referenceNo=models.CharField(max_length=20,blank=True,unique=True, default=uuid.uuid1)
    ...
    reserve_status=models.CharField(max_length=20,null=True,default='Pending')
